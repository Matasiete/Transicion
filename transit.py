...
def alinear_pieza_por_rumbo(pieza_fija, pieza_movil, rumbo_actual):
    ...
    # Corrección para CI45 y CD45 (ajusta el signo según cómo esté dibujada la pieza)
    if id_actual == "CI45":
        angulo_final_rotacion += 135   # o -135, prueba
    elif id_actual == "CD45":
        angulo_final_rotacion -= 135   # o +135, prueba
...
def alinear_pieza_por_rumbo(pieza_fija, pieza_movil, rumbo_actual):
    ...
    # Rotación con compensación

    angulo_final_rotacion = rumbo_actual
    if id_actual == "CI45":
        angulo_final_rotacion -= 135
    elif id_actual == "CD45":
        angulo_final_rotacion += 135
    ...
    return {
        "id_pieza": id_actual,           # clave real ("a", "2'", "x", etc.)
        "hitbox": hitbox_final,
        "entrada": entrada_situada,
        "salida": salida_final,
        "colisiona": False
...
if __name__ == "__main__":
    ...
    arquitecto = Arquitecto.crear_arquitecto()   # o Arquitecto.Arquitecto()
    
    # Generar el circuito (máximo 2000 intentos por defecto)
    secuencia_prueba = arquitecto.generar_circuito_valido()
